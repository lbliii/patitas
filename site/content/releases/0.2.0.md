...
Deterministic output for cache-key stability. See [Serialization](/docs/extending/serialization/).
...
- [Serialization](/docs/extending/serialization/) — Cache and transfer AST
